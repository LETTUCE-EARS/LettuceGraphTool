...
const init_phones = [],// Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      autoEqMode = 'IE';                            // AutoEQ smoothing mode, accepts 'IE' or 'OE'.                         // Max EQ bands available
...
const  preference_bounds_name = "Bounds",              // Preference bounds name
       ...
       default_DF_name = "Test",                   // Default RAW DF name
       ...
       tiltableTargets = ["Test"],                 // Targets that are allowed to be tilted
       compTargets = ["Test"],                     // Targets that are allowed to be used for compensation
